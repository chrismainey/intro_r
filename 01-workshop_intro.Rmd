...
.pull-left[
## Morning
What is R & using R Studio <br/>
<br/> Objects and data types<br/>
<br/> Importing data <br/>
<br/> --------- Break --------- <br/>
<br/> Data wrangling with dplyr <br/>
<br/> Relational data <br/>
<br/> Connecting to databases <br/>
]

.pull-right[
##Afternoon
<br/> Introduction to ggplot2 <br/>
<br/> What's a function, and what does it do? <br/>
<br/> --------- Break --------- <br/>
<br/> R Markdown <br/>
...
18,903 packages (December 2023). Free. Peer reviewed.  


(Manifold possibilities) e.g. interactive graphics and  
