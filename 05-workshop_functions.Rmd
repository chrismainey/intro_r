...
Functions considers inputs and outputs, and performs an action on them in between.

_(bad explanation, but stay with me...)_

--

Imagine you want to multiply numbers by 2...:

--

.pull-left[
#### You have code like this:
```{r orig2, eval=TRUE, collapse=TRUE}
old_nums <- c(2,5,12,15,6)
...
```{r asfunc2, eval=TRUE, collapse=TRUE}
my_function <- function(num){
  rtn <- num * 2
  return(rtn)
}

new_nums <- my_function(old_nums)
new_nums
```
]
